...
\section{{\faPieChart} Experience}
  \resumeSubHeadingListStart
      ...
      \resumeItemListStart
       ...
       \resumeItem{Support-lib \& Starter kit}
       {Implemented the In-house utility for handling form inputs that decreased the development time by approx 5\%. Accomplished 300\% improvement in scaffolding new React projects by creating a starter kit & developing a CLI tool.}
       \resumeItem{Simba}

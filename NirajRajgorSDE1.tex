...
\section{{\faPieChart} Experience}
  \resumeSubHeadingListStart
      ...
      \resumeItem{Jewelfleet}
       {Architected \& implemented the server-side rendering in React with Redux for a responsive e-commerce application that improved performance \& SEO. Worked on authentication, device identification, filters, pagination \& configured build system. In the team of 2, assigned tasks, performed code reviews \& implemented POCs.}
      \resumeItemListEnd
